...
class DefaultExceptionSubscriberTest extends UnitTestCase {
  ...
  public function testOnException() {
    ...
    $this->assertStringContainsString('Whoops! There was an error.', $response->getContent());
    $this->assertStringContainsString('Houston, we have a problem', $response->getContent());
  }
